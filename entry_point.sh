...
apt-get install -y --no-install-recommends ncurses perl wget ca-certificates > /dev/null 2>&1
...
pushd $PKGS
wget http://ftp.riken.jp/Linux/kernel.org/linux/kernel/v4.x/linux-4.16.3.tar.xz
wget http://ftp.riken.jp/GNU/binutils/binutils-2.30.tar.xz
wget http://ftp.riken.jp/GNU/gcc/gcc-7.3.0/gcc-7.3.0.tar.xz
wget http://ftp.riken.jp/GNU/gmp/gmp-6.1.2.tar.bz2
wget http://ftp.riken.jp/GNU/mpfr/mpfr-4.0.1.tar.xz
wget http://ftp.riken.jp/GNU/mpc/mpc-1.1.0.tar.gz
wget http://ftp.riken.jp/GNU/glibc/glibc-2.27.tar.xz
wget https://www.busybox.net/downloads/busybox-1.28.3.tar.bz2
